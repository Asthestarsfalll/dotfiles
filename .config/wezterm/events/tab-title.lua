...
M.setup = function()
   wezterm.on('format-tab-title', function(tab, _tabs, _panes, _config, hover, max_width)
      ...
      -- Left semi-circle
      _push(global_bg, bg, { Intensity = 'Bold' }, GLYPH_SEMI_CIRCLE_LEFT)

      -- Admin Icon
      if is_admin then
         _push(bg, global_bg, { Intensity = 'Bold' }, ' ' .. GLYPH_ADMIN)
      end
      ...
      -- Right semi-circle
      _push(global_bg, bg, { Intensity = 'Bold' }, GLYPH_SEMI_CIRCLE_RIGHT)
